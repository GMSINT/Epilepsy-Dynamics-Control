...
from LMIs_controller_mass_spring import P, G # Please change the name of 'LMIs for designing an FTS controller for the mass-spring-damper example model' to LMIs_controller_mass_spring
